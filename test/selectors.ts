// ref: https://github.com/web-platform-tests/wpt/blob/master/dom/nodes/ParentNode-querySelector-All.js
// ref: https://github.com/web-platform-tests/wpt/blob/master/dom/nodes/selectors.js
...
export const TEST_QSA = 0x01; // querySelector() and querySelectorAll() tests
export const TEST_FIND = 0x04; // find() and findAll() tests, may be unsuitable for querySelector[All]
export const TEST_MATCH = 0x10; // matches() tests
export const TEST_JN = 0x20; // JsonNode tests
 ...
 */
export const invalidSelectors: SelectorTest[] = [
	//{ name: 'Empty String', selector: '' },
	{ name: 'Invalid character', selector: '[', expect: ['[', '0'] },
	{ name: 'Invalid character', selector: ']', expect: [']', '0'] },
	{ name: 'Invalid character', selector: '(', expect: ['(', '0'] },
	{ name: 'Invalid character', selector: ')', expect: [')', '0'] },
	{ name: 'Invalid character', selector: '{', expect: ['{', '0'] },
	...
	{ name: 'Invalid character', selector: '<', expect: ['<', '0'] },
	{ name: 'Invalid character', selector: '>', expect: ['>', '0'] },
	{ name: 'Invalid ID', selector: '#', expect: ['#', '0'] },
	{ name: 'Invalid group of selectors', selector: 'div,', expect: ['', '4'] },
	{ name: 'Invalid class', selector: '.', expect: ['.', '0'] },
	{ name: 'Invalid class', selector: '.5cm', expect: ['.', '0'] },
	{ name: 'Invalid class', selector: '..test', expect: ['.', '0'] },
	{ name: 'Invalid class', selector: '.foo..quux', expect: ['.', '4'] },
	{ name: 'Invalid class', selector: '.bar.', expect: ['.', '4'] },
	{ name: 'Invalid combinator', selector: 'div & address, p', expect: ['&', '4'] },
	{ name: 'Invalid combinator', selector: 'div ++ address, p', expect: ['+ ', '5'] },
	{ name: 'Invalid combinator', selector: 'div ~~ address, p', expect: ['~ ', '5'] },
	{ name: 'Invalid [att=value] selector', selector: '[*=test]', expect: ['[', '0'] },
	{ name: 'Invalid [att=value] selector', selector: '[*|*=test]', expect: ['[', '0'] },
	{ name: 'Invalid [att=value] selector', selector: '[class= space unquoted ]', expect: ['[', '0'] },
	{ name: 'Unknown pseudo-class', selector: 'div:example', expect: ['example', '4'] },
	{ name: 'Unknown pseudo-class', selector: ':example', expect: ['example', '1'] },
	{ name: 'Unknown pseudo-class', selector: 'div:linkexample', expect: ['linkexample', '4'] },
	{ name: 'Unknown pseudo-element', selector: 'div::example', expect: [':', '3'] },
	{ name: 'Unknown pseudo-element', selector: '::example', expect: [':', '0'] },
	{ name: 'Invalid pseudo-element', selector: ':::before', expect: [':', '0'] },
	{ name: 'Invalid pseudo-element', selector: ':: before', expect: [':', '0'] },
	{ name: 'Invalid expression', selector: ':not()', expect: ['', '0'] },
	{ name: 'Invalid expression', selector: ':not(1)', expect: ['1', '5'] },
	{ name: 'Invalid expression', selector: ':nth-child()', expect: [':', '0'] },
	{ name: 'Invalid expression', selector: ':nth-child(-1+n)', expect: ['n', '14'] },
	{ name: 'Invalid expression', selector: ':nth-child(2n+-1)', expect: ['-', '14'] },
	{ name: 'Invalid expression', selector: ':nth-child(2n--1)', expect: ['-', '14'] },
	{ name: 'Undeclared namespace', selector: 'ns|div', expect: ['|', '2'] },
	{ name: 'Undeclared namespace', selector: ':not(ns|div)', expect: ['|', '7'] },
	{ name: 'Invalid namespace', selector: '^|div', expect: ['^', '0'] },
	{ name: 'Invalid namespace', selector: '$|div', expect: ['$', '0'] },
	{ name: 'Relative selector', selector: '>*', expect: ['>', '0'] },
];
 ...
 */
export const validSelectors: SelectorTest[] = [
	// Type Selector
	{
	...
	},
	{
		...
		selector: '#universal>*',
		expect: ['universal-p1', 'universal-hr1', 'universal-pre1', 'universal-p2', 'universal-address1'],
		level: 2,
		testType: TEST_QSA | TEST_MATCH,
	},
	{
		...
		selector: '#universal>*>*',
		expect: ['universal-code1', 'universal-span1', 'universal-a1', 'universal-code2'],
		level: 2,
		testType: TEST_QSA | TEST_MATCH,
	},
	{
	...
	},
	{
		...
		expect: ['attr-presence-a1', 'attr-presence-span1', 'attr-presence-i1'],
		exclude: ['nonamespace'],
		level: 2,
		testType: TEST_QSA | TEST_MATCH,
	},
	...
	},
	{
		...
		expect: ['attr-presence-select3-option2', 'attr-presence-select3-option3'],
		level: 2,
		testType: TEST_QSA | TEST_MATCH,
	},
	...
	{
		name: 'Attribute value selector, matching align attribute with value, unclosed quote',
		selector: '#attr-value [data-attr-value="value with space]',
		expect: ['attr-value-div6'],
		level: 2,
		testType: TEST_QSA | TEST_MATCH,
	},
	{
		name: 'Attribute value selector, matching align attribute with value, unclosed quote and braket',
		selector: '#attr-value [align="center',
		expect: ['attr-value-div1'],
		level: 2,
		testType: TEST_QSA | TEST_MATCH,
	...
	},
	{
		...
		expect: ['attr-value-input3', 'attr-value-input4', 'attr-value-input6', 'attr-value-input8', 'attr-value-input9'],
		level: 2,
		testType: TEST_QSA | TEST_MATCH,
	},
	{
	...
	},
	{
		...
		expect: ['attr-whitespace-a1', 'attr-whitespace-a2', 'attr-whitespace-a3', 'attr-whitespace-a5', 'attr-whitespace-a7'],
		level: 2,
		testType: TEST_QSA | TEST_MATCH,
	},
	{
	...
	// XXX write descriptions
	{
		...
		expect: ['pseudo-nth-td3', 'pseudo-nth-td9', 'pseudo-nth-tr3', 'pseudo-nth-td15'],
		level: 3,
		testType: TEST_QSA | TEST_MATCH,
	},
	{
		name: ':nth-child selector, matching the third child element offset by -1',
		selector: '#pseudo-nth-table1 :nth-child(-3n+2)',
		expect: ['pseudo-nth-td2', 'pseudo-nth-tr2', 'pseudo-nth-td8', 'pseudo-nth-td14'],
		level: 3,
		testType: TEST_QSA | TEST_MATCH,
	},
	{
		name: ':nth-child selector, matching the first two element',
		selector: '#pseudo-nth-table1 :nth-child(-n+2)',
		expect: [
			'pseudo-nth-tr1',
			'pseudo-nth-td1',
			'pseudo-nth-td2',
	...
	{
		name: ':nth-child selector, matching nothing',
		selector: '#pseudo-nth-table1 :nth-child(-3n-2)',
		expect: [],
		level: 3,
		testType: TEST_QSA | TEST_MATCH,
	},
	{
		...
		expect: ['pseudo-nth-li3', 'pseudo-nth-li6', 'pseudo-nth-li9', 'pseudo-nth-li12'],
		level: 3,
		testType: TEST_QSA | TEST_MATCH,
	},
	{
		...
		expect: ['pseudo-nth-li4', 'pseudo-nth-li6', 'pseudo-nth-li8', 'pseudo-nth-li10', 'pseudo-nth-li12'],
		level: 3,
		testType: TEST_QSA | TEST_MATCH,
	},
	{
	...
	// - :nth-last-child       (Level 3)
	{
		...
		expect: ['pseudo-nth-tr1', 'pseudo-nth-td4', 'pseudo-nth-td10', 'pseudo-nth-td16'],
		level: 3,
		testType: TEST_QSA | TEST_MATCH,
	},
	{
		...
		expect: ['pseudo-nth-li1', 'pseudo-nth-li4', 'pseudo-nth-li7', 'pseudo-nth-li10'],
		level: 3,
		testType: TEST_QSA | TEST_MATCH,
	},
	{
		...
		expect: ['pseudo-nth-li1', 'pseudo-nth-li3', 'pseudo-nth-li5', 'pseudo-nth-li7', 'pseudo-nth-li9'],
		level: 3,
		testType: TEST_QSA | TEST_MATCH,
	},
	{
	...
	},
	{
		...
		expect: ['pseudo-nth-em2', 'pseudo-nth-span2', 'pseudo-nth-span4', 'pseudo-nth-strong2', 'pseudo-nth-em4'],
		level: 3,
		testType: TEST_QSA | TEST_MATCH,
	},
	{
	...
	},
	{
		...
		expect: ['pseudo-nth-span1', 'pseudo-nth-em1', 'pseudo-nth-strong1', 'pseudo-nth-em3', 'pseudo-nth-span3'],
		level: 3,
		testType: TEST_QSA | TEST_MATCH,
	},
	{
	...
	},
	{
		...
		expect: ['pseudo-first-child-span1', 'pseudo-first-child-span3', 'pseudo-first-child-span5'],
		level: 2,
		testType: TEST_QSA | TEST_MATCH,
	},
	...
	},
	{
		...
		expect: ['pseudo-last-child-span2', 'pseudo-last-child-span4', 'pseudo-last-child-span6'],
		level: 3,
		testType: TEST_QSA | TEST_MATCH,
	},
	...
	},
	{
		name: ':empty pseudo-class selector, matching empty p elements',
		selector: '#pseudo-empty p:empty',
		expect: ['pseudo-empty-p1', 'pseudo-empty-p2', 'pseudo-empty-p3'],
		exclude: ['html'],
		level: 3,
		testType: TEST_QSA | TEST_MATCH,
	},
	{
		name: ':empty pseudo-class selector, matching all empty elements',
		selector: '#pseudo-empty :empty',
		expect: ['pseudo-empty-p1', 'pseudo-empty-p2', 'pseudo-empty-p3', 'pseudo-empty-span1'],
		exclude: ['html'],
		level: 3,
		testType: TEST_QSA | TEST_MATCH,
	},
	...
	},
	{
		...
		expect: [] /*no matches*/,
		exclude: ['element', 'fragment', 'detached', 'xhtml'],
		level: 1,
		testType: TEST_QSA | TEST_MATCH,
	},
	{
	...
	// - :target               (Level 3)
	{
		...
		selector: ':target',
		expect: [] /*no matches*/,
		exclude: ['document', 'element', 'xhtml'],
		level: 3,
		testType: TEST_QSA,
	},
	{
		...
		selector: ':target',
		expect: ['target'],
		exclude: ['fragment', 'detached', 'xhtml'],
		level: 3,
		testType: TEST_QSA | TEST_MATCH,
	},
	...
	// - :lang()
	{
		...
		exclude: ['detached', 'fragment', 'xhtml'],
		level: 2,
		testType: TEST_QSA | TEST_MATCH,
	},
	{
	...
	},
	{
		...
		expect: [] /*no matches*/,
		unexpected: ['pseudo-link-a1', 'pseudo-link-a2', 'pseudo-link-a3', 'pseudo-link-map1', 'pseudo-link-area1', 'pseudo-link-area2'],
		exclude: ['xhtml'],
		level: 3,
		testType: TEST_QSA | TEST_MATCH,
	},
	...
	// - :checked              (Level 3)
	{
		...
		expect: ['pseudo-ui-input4', 'pseudo-ui-input6', 'pseudo-ui-input13', 'pseudo-ui-input15'],
		exclude: ['xhtml'],
		level: 3,
		testType: TEST_QSA | TEST_MATCH,
	},
	...
	// - :not(s)               (Level 3)
	{
		name: ':not pseudo-class selector (no matching closing paren), matching ',
	...
	{
		name: ':not pseudo-class selector with group of selectors, matching ',
		selector: '#not :not(p, span)',
		expect: ['not-div1', 'not-div2', 'not-div3', 'not-em1', 'not-em2', 'not-em3'],
		level: 3,
		testType: TEST_QSA | TEST_MATCH,
	},
	{
	...
	},
	{
		...
		expect: ['class-div1', 'class-div2', 'class-p4', 'class-div3', 'class-p6', 'class-div4'],
		level: 1,
		testType: TEST_QSA | TEST_MATCH,
	},
	{
	...
	{
		name: 'Class selector, matching element with class starts with hyphen',
		selector: '.-hyphen',
		expect: ['class-span5', 'class-span6'],
		level: 1,
		testType: TEST_QSA | TEST_MATCH,
	},
	...
	},
	{
		...
		expect: ['id-li-duplicate', 'id-li-duplicate', 'id-li-duplicate', 'id-li-duplicate'],
		level: 1,
		testType: TEST_QSA | TEST_MATCH,
	},
	...
	// XXX runMatchesTest() in level2-lib.js can't handle these because non-HTML elements don't have a recognised id
	{
		...
		expect: ['any-namespace-div1', 'any-namespace-div2', 'any-namespace-div3', 'any-namespace-div4'],
		exclude: ['nonamespace'],
		level: 3,
		testType: TEST_QSA,
	},
	...
	// - Descendant combinator ' '
	{
		...
		expect: ['descendant-div1', 'descendant-div2', 'descendant-div3', 'descendant-div4'],
		level: 1,
		testType: TEST_QSA | TEST_MATCH,
	},
	{
	...
	{
		name: 'Descendant combinator, followed by Child combinator',
		selector: '#descendant div>div',
		expect: ['descendant-div2', 'descendant-div3'],
		level: 2,
		testType: TEST_QSA | TEST_MATCH,
	},
	...
	{
		name: 'Child combinator, followed by Descendant combinator',
		selector: '#child>#child-div1 div',
		expect: ['child-div2', 'child-div3'],
		level: 2,
		testType: TEST_QSA | TEST_MATCH,
	},
	...
	{ name: 'Slotted selector', selector: '::slotted(foo)', expect: [], exclude: [], level: 3, testType: TEST_QSA },
	{
 ...
 *
 *   exclude:   An array of contexts to exclude from testing. The valid values are:
 *              ["document", "element", "fragment", "detached", "html", "xhtml", "nonamespace"]
 *              The "html" and "xhtml" values represent the type of document being queried. These are useful
 *              for tests that are affected by differences between HTML and XML, such as case sensitivity.
 *
 *   level:     An integer indicating the CSS or Selectors level in which the selector being tested was introduced.
...
export const scopedSelectors: SelectorTest[] = [
...
export const escapeSelectors: EscapeTest[] = [
	//{ name: 'String conversion', selector: (true), expect:'true'},
	//{ name: 'String conversion', selector: (false), expect:'false'},
	//{ name: 'String conversion', selector: (null), expect:'null'},
	{ name: 'String conversion', selector: '', expect: '' },

	{ name: 'Null bytes', selector: '\0', expect: '\uFFFD' },
	{ name: 'Null bytes', selector: 'a\0', expect: 'a\uFFFD' },
	{ name: 'Null bytes', selector: '\0b', expect: '\uFFFDb' },
	{ name: 'Null bytes', selector: 'a\0b', expect: 'a\uFFFDb' },

	{ name: 'Replacement character', selector: '\uFFFD', expect: '\uFFFD', exclude: ['unescape'] },
	{ name: 'Replacement character', selector: 'a\uFFFD', expect: 'a\uFFFD', exclude: ['unescape'] },
	{ name: 'Replacement character', selector: '\uFFFDb', expect: '\uFFFDb', exclude: ['unescape'] },
	{ name: 'Replacement character', selector: 'a\uFFFDb', expect: 'a\uFFFDb', exclude: ['unescape'] },

	{ name: 'Number prefix', selector: '0a', expect: '\\30 a' },
	{ name: 'Number prefix', selector: '1a', expect: '\\31 a' },
	{ name: 'Number prefix', selector: '2a', expect: '\\32 a' },
	{ name: 'Number prefix', selector: '3a', expect: '\\33 a' },
	{ name: 'Number prefix', selector: '4a', expect: '\\34 a' },
	{ name: 'Number prefix', selector: '5a', expect: '\\35 a' },
	{ name: 'Number prefix', selector: '6a', expect: '\\36 a' },
	{ name: 'Number prefix', selector: '7a', expect: '\\37 a' },
	{ name: 'Number prefix', selector: '8a', expect: '\\38 a' },
	{ name: 'Number prefix', selector: '9a', expect: '\\39 a' },

	{ name: 'Letter number prefix', selector: 'a0b', expect: 'a0b' },
	{ name: 'Letter number prefix', selector: 'a1b', expect: 'a1b' },
	{ name: 'Letter number prefix', selector: 'a2b', expect: 'a2b' },
	{ name: 'Letter number prefix', selector: 'a3b', expect: 'a3b' },
	{ name: 'Letter number prefix', selector: 'a4b', expect: 'a4b' },
	{ name: 'Letter number prefix', selector: 'a5b', expect: 'a5b' },
	{ name: 'Letter number prefix', selector: 'a6b', expect: 'a6b' },
	{ name: 'Letter number prefix', selector: 'a7b', expect: 'a7b' },
	{ name: 'Letter number prefix', selector: 'a8b', expect: 'a8b' },
	{ name: 'Letter number prefix', selector: 'a9b', expect: 'a9b' },

	{ name: 'Dash number prefix', selector: '-0a', expect: '-\\30 a' },
	{ name: 'Dash number prefix', selector: '-1a', expect: '-\\31 a' },
	{ name: 'Dash number prefix', selector: '-2a', expect: '-\\32 a' },
	{ name: 'Dash number prefix', selector: '-3a', expect: '-\\33 a' },
	{ name: 'Dash number prefix', selector: '-4a', expect: '-\\34 a' },
	{ name: 'Dash number prefix', selector: '-5a', expect: '-\\35 a' },
	{ name: 'Dash number prefix', selector: '-6a', expect: '-\\36 a' },
	{ name: 'Dash number prefix', selector: '-7a', expect: '-\\37 a' },
	{ name: 'Dash number prefix', selector: '-8a', expect: '-\\38 a' },
	{ name: 'Dash number prefix', selector: '-9a', expect: '-\\39 a' },

	{ name: 'Double dash prefix', selector: '--a', expect: '--a' },

	{ name: 'Multiple non-printable characters', selector: '\x01\x02\x1E\x1F', expect: '\\1 \\2 \\1e \\1f ' },
	{
		name: 'Multiple non-printable characters',
		selector: '\x01\x02\x1E\x1F',
		expect: '\\000001 \\000002 \\00001e \\00001f ',
		exclude: ['escape'],
	},

	{ name: 'Multiple characters', selector: '\x80\x2D\x5F\xA9', expect: '\x80\x2D\x5F\xA9' },
	{
	...
	{ name: 'Multiple characters', selector: '\xA0\xA1\xA2', expect: '\xA0\xA1\xA2' },
	{
		name: 'Multiple characters',
		selector: '\u53F0\u5317Ta\u0301ibe\u030Ci',
		expect: '\\53F0\\5317Ta\\0301ibe\\030Ci',
		exclude: ['escape'],
	},
	{ name: 'Multiple printable characters', selector: 'a0123456789b', expect: 'a0123456789b' },
	{ name: 'Multiple printable characters', selector: 'abcdefghijklmnopqrstuvwxyz', expect: 'abcdefghijklmnopqrstuvwxyz' },
	{ name: 'Multiple printable characters', selector: 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', expect: 'ABCDEFGHIJKLMNOPQRSTUVWXYZ' },

	{ name: 'Backslashes get backslash-escaped', selector: 'hello\\world', expect: 'hello\\\\world' },
	{ name: 'Code points greater than U+0080 are preserved', selector: 'hello\u{1234}world', expect: 'hello\u{1234}world' },

	{ name: 'Single dash escaped', selector: '-', expect: '\\-' },
	{ name: 'Colons escaped', selector: 'foo::bar', expect: 'foo\\:\\:bar' },
	{ name: 'Dot and Hash escaped', selector: '.foo#bar', expect: '\\.foo\\#bar' },
	{ name: 'Brackets escaped', selector: '(a)[b]{c}', expect: '\\(a\\)\\[b\\]\\{c\\}' },
	{ name: 'Quotes escaped', selector: "'foo'", expect: "\\'foo\\'" },
	{ name: 'Quotes escaped', selector: '"foo"', expect: '\\"foo\\"' },
	{ name: 'Vertical bar escaped', selector: 'foo|bar', expect: 'foo\\|bar' },

	{ name: 'Space escaped', selector: '\x20\x21\x78\x79', expect: '\\ \\!xy', exclude: ['unescape'] },

	// astral symbol (U+1D306 TETRAGRAM FOR CENTRE)
	{ name: 'Astral symbol', selector: '\uD834\uDF06', expect: '\uD834\uDF06' },
	// lone surrogates
	{ name: 'Long surrogates', selector: '\uDF06', expect: '\uDF06' },
	{ name: 'Long surrogates', selector: '\uD834', expect: '\uD834' },
];
